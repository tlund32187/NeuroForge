...
Workflow:
  ...
  3. Run this file (Run/▶ on "NeuroForge: calibrate HUD", or from a terminal).
...
The ROIs here should match neuroforge.game.vision.rois — adjust both together.
"""
...
# ── SPEC — edit these after viewing a captured frame ──────────────────────────
