...
from neuroforge.kernel.torch_utils import cuda_maybe_sync, require_torch
...
from neuroforge.simulation.runtime.run_context import RunContext, create_run_dir
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m neuroforge.interfaces.cli.commands.vision_bench",
...
def main(argv: list[str] | None = None) -> None:
    """CLI entrypoint for ``python -m neuroforge.interfaces.cli.commands.vision_bench``."""
    sys.exit(_main(argv))
