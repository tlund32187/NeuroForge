...
__all__ = ["ActionDecodeConfig", "ActionDecoder", "IActionDecoder"]
...
@runtime_checkable
class IActionDecoder(Protocol):
    """Converts motor readout values into controller actions."""

    def decode(self, motor_rates: Any) -> ControllerAction:
        """Decode motor rates into an action."""
        ...
