...
Implements :class:`~neuroforge.contracts.game.IFrameMetricExtractor`: turns a
...
from neuroforge.contracts.game import ScreenFrame, VisionGameMetrics

if TYPE_CHECKING:
    from numpy.typing import NDArray
from neuroforge.game.vision.digit_reader import DigitGlyphAtlas, read_field, to_grayscale
from neuroforge.game.vision.progress_estimator import ScrollProgressEstimator
from neuroforge.game.vision.rois import HudLayout, smb3_level_layout
