...
components in :class:`~neuroforge.factories.hub.FactoryHub`, so they get their
own registry here (separation of concerns) while reusing the same generic
:class:`~neuroforge.core.registry.Registry`. A future game task resolves a
...
def build_game_client_registry() -> Registry:
    ...
    from neuroforge.game.clients.bizhawk_client import BizHawkClient
    from neuroforge.game.clients.scripted import ReplayGameClient, ScriptedGameClient
