...
from neuroforge.applications.tasks.logic_gates import GATE_TABLES
...
from neuroforge.kernel.torch_utils import require_torch, resolve_device_dtype, smart_device
from neuroforge.learning.encoders.rate import RateEncoderParams
...
if TYPE_CHECKING:
    ...
    from neuroforge.simulation.engine.core import CoreEngine, Projection
...
def build_gate_network(
    ...
    *hub* defaults to :data:`~neuroforge.construction.hub.DEFAULT_HUB`; pass a
...
class MultiGateTask(BaseTask):
    ...
    def __init__(
        ...
        *hub* defaults to :data:`~neuroforge.construction.hub.DEFAULT_HUB`; inject
