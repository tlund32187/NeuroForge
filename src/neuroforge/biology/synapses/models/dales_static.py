...
weights via the Dale reparameterisation::
    ...
    w_eff = |w_raw| Ã— sign_pre[pre_idx]
...
class DalesStaticSynapseModel:
    ...
    def init_state(
        ...
        """Dale synapse has no internal state â€” return empty dict."""
        return {}
    ...
    def step(
        ...
        The effective weight for edge *e* is::
            ...
            w_eff[e] = |weights[e]| Ã— sign_pre[pre_idx[e]]
        """
        ...
        # Apply Dale reparameterisation: |w| Ã— sign.
        ...
        # Spike contribution â€” float or bool.
